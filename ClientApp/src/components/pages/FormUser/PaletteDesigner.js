...
class PaletteDesignerPage extends Component {
  ...
  handleAutoGeneratePrepos = ({ name }) => event => {
    ...
    //   ((this.casedataA1 && this.casedataA1[this.freesedCaseCount]) ? (this.casedataA1[this.freesedCaseCount].auto_generation == true ?
    //     this.setState({
    //       autoGenerateRadioButton: true
    //     })
    //     :
    ...
    //   ((this.casedataA2 && this.casedataA2[this.freesedCaseCount]) ? (this.casedataA2[this.freesedCaseCount].auto_generation == true ?
    //     this.setState({
    //       autoGenerateRadioButton: true
    //     })
    //     :
    ...
    //   ((this.casedataB1 && this.casedataB1[this.freesedCaseCount]) ? (this.casedataB1[this.freesedCaseCount].auto_generation == true ?
    //     this.setState({
    //       autoGenerateRadioButton: true
    //     })
    //     :
    ...
    //   ((this.casedataB2 && this.casedataB2[this.freesedCaseCount]) ? (this.casedataB2[this.freesedCaseCount].auto_generation == true ?
    //     this.setState({
    //       autoGenerateRadioButton: true
    //     })
    //     :
    ...
    //   ((this.casedataC1 && this.casedataC1[this.freesedCaseCount]) ? (this.casedataC1[this.freesedCaseCount].auto_generation == true ?
    //     this.setState({
    //       autoGenerateRadioButton: true
    //     })
    //     :
    ...
    //   ((this.casedataC2 && this.casedataC2[this.freesedCaseCount]) ? (this.casedataC2[this.freesedCaseCount].auto_generation == true ?
    //     this.setState({
    //       autoGenerateRadioButton: true
    //     })
    //     :
    ...
    // console.log("Inside handleAutoGeneratePrepos this.casedata = ", this.casedata);
  ...
  OffsetChangePrc = (index, value, e) => {
    ...
    if (e == "rotation") {
      ...
      if (e.target.name === "position_freezed") {
        ...
        // toUpdateCaseData[index].auto_generation = false;
        // this.setState({
        //   autoGenerateRadioButton: false,
        // })
        // if (this.state.selectedOne) {
        //   if (this.colorA == "#5eb8b3") {
        //     for (let i = 0; i < this.casedataA1.length; i++) {
        //       this.casedataA1[i].auto_generation = false;
        //     }
        //   } else if (this.colorB == "#5eb8b3") {
        //     for (let i = 0; i < this.casedataB1.length; i++) {
        //       this.casedataB1[i].auto_generation = false;
        //     }
        //   } else if (this.colorC == "#5eb8b3") {
        //     for (let i = 0; i < this.casedataC1.length; i++) {
        //       this.casedataC1[i].auto_generation = false;
        //     }
        //   }
        // } else if (this.state.selectedTwo) {
        //   if (this.colorA == "#5eb8b3") {
        //     for (let i = 0; i < this.casedataA2.length; i++) {
        //       this.casedataA2[i].auto_generation = false;
        //     }
        //   } else if (this.colorB == "#5eb8b3") {
        //     for (let i = 0; i < this.casedataB2.length; i++) {
        //       this.casedataB2[i].auto_generation = false;
        //     }
        //   } else if (this.colorC == "#5eb8b3") {
        //     for (let i = 0; i < this.casedataC2.length; i++) {
        //       this.casedataC2[i].auto_generation = false;
        //     }
        //   }
        // }
                      ...
                      <Grid container style={containerGridstyle} >
                        ...
                        <Grid item xs={12} style={{ display: 'flex', flexDirection: 'row', padding: 0, width: "100%", height: "48px", backgroundColor: color1, marginBottom: "4px" }}>
                          ...
                          <TextField
                            ...
                            InputLabelProps={{
                              shrink: true,
                              style: { color: this.state.simulationStatus == t("passed") ? "green" : "red", fontSize: "12px", top: "3px" }
                            }}
                            InputProps={{
                              style: { color: this.state.simulationStatus == t("passed") ? "green" : "red", fontSize: "12px", top: "3px" },
                              disableUnderline: true
