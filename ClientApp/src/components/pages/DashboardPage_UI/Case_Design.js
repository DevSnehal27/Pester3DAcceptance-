                            ...
                            >
                                <FormControlLabel
                                    ...
                                    label={
                                        <Box
                                            component="div"
                                            style={{ width: "110px",userSelect: "none", fontSize: "12px !important", marginTop: "12px", marginLeft: "-14px", marginBottom: "10px", lineHeight: "1", lineBreak: "auto", }}
                                            fontsize={12}
                                        >
                                            {t("editCase")}
                                        </Box>
                                ...
                                <FormControlLabel className=""
                                    ...
                                    label={
                                        <Box className=""
                                            component="div"
                                            style={{ width: "100px",  userSelect: "none", fontSize: "12px !important", marginTop: "11px", marginLeft: "13px", lineBreak: "auto", lineHeight: "1", marginBottom: "9px" }}
                                            fontsize={12}
                                        >
                                            {t("deleteCase")}
                                        </Box>
                                ...
                                <FormControlLabel
                                    ...
                                    label={
                                        <Box
                                            component="div"
                                            style={{ width: "129px", userSelect: "none", pointerEvents: "none", fontSize: "12px !important", marginTop: "7px", marginLeft: "21px", marginBottom: "4px", lineBreak: "auto", lineHeight: 1, }}
                                            fontsize={12}
                                        >
                                            {t("exportData")}
                                        </Box>
